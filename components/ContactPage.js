                    ...
                    <div className="columns">
                        <div className="column">
                            ...
                            <h2 className="subtitle">
                                Rozumiemy otoczenie biznesowe w którym działamy, dlatego proponujemy i wdrażamy
                                rozwiązania IT najlepsze dla Twoich potrzeb biznesowych.
                            </h2>
                        </div>
                        <div className="column">
                                    ...
                                    <label className="checkbox">
                                        <input
                                            ...
                                            className={`form__checkbox ${
                                                errors.agreement ? 'form__checkbox-error' : null
                                            }`}
                                            ref={register({ required: true })}
                                        />
