                                ...
                                <div className="media-content">
                                    <div className="content">
                                        <p>
                                            ...
                                            <br />
                                            do 115 PLN/h (B2B) do 14500 PLN (UOP)
                                        </p>
                                    </div>
                    ...
                    <div className="column">
                        <div className="container pb-6">
                            ...
                            <ul className="offer__list">
                                ...
                                <li>Follow existing standards in software development process</li>
                            </ul>
                        </div>
                        <div className="container pb-6">
                            <h1 className="title">Nice to have</h1>
                            <ul className="offer__list">
                                <li>Prior experience in designing and programming microcontrollers and processors</li>
                                <li>Knowledge of SW engineering tools supporting software production process</li>
                            </ul>
                        </div>
                    </div>
                </div>
