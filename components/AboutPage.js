            ...
            <div className='home home--30'>
                <div className='about__container'>
                    <h2 className='about__title'>
                        Pierwsza agencja rekrutacyjna IT dedykowana start-upom i firmom produktowym
                    </h2>
                </div>
            </div>
                    ...
                    <div className='column'>
                        <div className='container'>
                            ...
                            <h2 className='subtitle'>
                                Działamy w branży IT od 2005 roku. Współpracujemy z globalnymi korporacjami, a także
                                innymi firmami, głównie z Europy. Specjalizujemy się w tworzeniu oprogramowania, ale
                                mamy również duże doświadczenie w outsourcingu specjalistów i zespołów IT, a także w
                                modelu Build-Operate-Transfer.
                                <br />
